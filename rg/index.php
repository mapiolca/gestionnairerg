...
print '<div class="nowrapfordate">'.$langs->trans('From').' '.$form->selectDate($search_date_reception_start, 'search_date_reception_start', 0, 0, 1, '', 0, 0).'</div>';
print '<div class="nowrapfordate">'.$langs->trans('to').' '.$form->selectDate($search_date_reception_end,   'search_date_reception_end',   0, 0, 1, '', 0, 0).'</div>';
print '</td>';
print '<td class="liste_titre_filter">';
print '<div class="nowrapfordate">'.$langs->trans('From').' '.$form->selectDate($search_date_limit_start,     'search_date_limit_start',     0, 0, 1, '', 0, 0).'</div>';
print '<div class="nowrapfordate">'.$langs->trans('to').' '.$form->selectDate($search_date_limit_end,       'search_date_limit_end',       0, 0, 1, '', 0, 0).'</div>';
print '</td>';
